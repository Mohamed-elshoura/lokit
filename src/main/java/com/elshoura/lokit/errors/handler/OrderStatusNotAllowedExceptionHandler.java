...
@ControllerAdvice
public class OrderStatusNotAllowedExceptionHandler {

    @ExceptionHandler(OrderStatusNotAllowedException.class)
    public ResponseEntity<ErrorDetails> handleOrderStatusNotAllowedException(OrderStatusNotAllowedException ex) {
